...
json_path = os.path.join(current_directory, 'djangofb-d586d-firebase-adminsdk-podbx-5f27a65054.json')

# Initialize the Firebase Admin SDK
cred = credentials.Certificate(json_path)
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://djangofb-d586d-default-rtdb.firebaseio.com/'  # Replace with your Firebase database URL
})
